...
function setup() {
  ...
  playGame = new Button(width / 2, height / 3, 100, 32, "Play", "menu", function() {
    state = "game";
  });
  helpBtn = new Button(width / 2, height / 2.5, 100, 32, "Controls", "menu", function() {
    state = "help";
  });
  ...
  backToMenu = new Button(50, 16, 100, 32, "<- Menu", "game", function() {
    state = "menu";
  });
  backToMenu2 = new Button(50, 16, 100, 32, "<- Menu", "help", function() {
    state = "menu";
  });
  backToMenu3 = new Button(50, 16, 100, 32, "<- Menu", "background", function() {
    state = "menu";
  });
  //Create UI
  p1c = {
